...
% Berdasarkan Panduan Tugas Akhir Teknik Informatika ITERA v1.3hj
...
\title{Deteksi Tingkat Kantuk pada Sinyal EEG dan EOG menggunakan Model Mamba: Studi Perbandingan Regresi dan Klasifikasi}
    % Judul Tugas Akhir dalam Bahasa Inggris
    \titleEN{Detection of Sleepiness Level in EEG and EOG Signals using Mamba Model: A Comparative Study of Regression and Classification}
    % JUDUL AKAN DITULIS DALAM HURUF KAPITAL; Font size 16 pt; Bold; Tidak melebihi 4 baris
    
    % Informasi Mahasiswa
    \author{Bintang Fikri Fauzan}
	\nim{122140008}				
	...
	\pengujiA%
		{Hartanto Tantriawan, S.Kom., M.Kom.}%				% Nama Dosen Penguji 1
		{NIP. 19920522 201903 1 012}	% NIP Dosen Penguji 1
	\pengujiB%
		{Mohamad Idris S.Si., M.Sc.}%				% Nama Dosen Penguji 2
		{NIP. 19861010 201903 1 016}	% NIP Dosen Penguji 2
